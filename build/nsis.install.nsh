...
!define HELPURL "https://github.com/WhaleCoinOrg/WhaleCoin/issues"
!define UPDATEURL "https://github.com/WhaleCoinOrg/WhaleCoin/releases"
!define ABOUTURL "https://github.com/WhaleCoinOrg/WhaleCoin#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30373)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30373)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30373)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30373)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30373 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30373)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30373 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30373)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30373 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gwhale.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gwhale.ipc"
